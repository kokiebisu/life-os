...
**消費報告が1食分の場合の計算（厳守）:** fridge.md の既存数量から1食分を引いた残量に更新する。**残量が0になって初めて削除する。** 「〜食べた」という報告だけで全量消費と決め打ちしない。daily ファイルの注釈（「最後の1食」等）と fridge.md の数量が矛盾する場合は、ユーザーに残量を確認してから更新する。
